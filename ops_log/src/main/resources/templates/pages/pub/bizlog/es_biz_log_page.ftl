...
<#else>
    ...
    <div style="display: none;">
        ...
        <input type="hidden" name="operatorNameIn" value="${operatorNameIn!''}" >
        <input type="hidden" name="operatorNameNotIn" value="${operatorNameNotIn!''}" >
...
<script type="text/javascript">
    $(function () {
        ...
        $.lvmm_log.init({
            ...
            url: '/lvmm_log/lvmmLogHealth/find',
            queryPams: [
                ...
                { name: "operatorNameIn", value: $("input[name='operatorNameIn']").val() },
                { name: "operatorNameNotIn", value: $("input[name='operatorNameNotIn']").val() },
